        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-6 rounded-4xl bg-gray-50 hover:bg-gray-100 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Free & Nonprofit</h3>
              <p className="text-gray-600">No cost for users or providers - we don't monetize your data</p>
            </div>
