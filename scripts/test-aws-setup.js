  ...
  try {
    ...
    try {
      ...
      if (error.name === 'InvalidParameterException') {
        ...
        console.log('   ✅ Textract API accessible');
        console.log('   ✅ Permissions correct (textract:AnalyzeID)');
        console.log('   ℹ️  Invalid parameter error is expected with test image');
        return true;
      }
      throw error;
    }
    ...
    if (error.name === 'UnrecognizedClientException' || error.name === 'InvalidSignatureException') {
      ...
      console.log('   - Check AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY in .env.local');
      ...
      console.log('   - You may need to attach AmazonTextractFullAccess policy');
...
async function testRekognition() {
  ...
  try {
    ...
    if (error.name === 'UnrecognizedClientException' || error.name === 'InvalidSignatureException') {
      ...
      console.log('   - You may need to attach AmazonRekognitionFullAccess policy');
    }
...
async function runTests() {
  console.log('═══════════════════════════════════════════════════════');
  console.log('   AWS Setup Test for CardlessID Verification');
  console.log('═══════════════════════════════════════════════════════');
  ...
  if (textractOk && rekognitionOk) {
    ...
    console.log('1. Set FACE_COMPARISON_PROVIDER=aws-rekognition in .env.local');
