      ...
      <div className="mb-8">
          ...
          <section id="overview" className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              ...
              decentralized identity credentials on the Algorand blockchain.
              Users prove they meet an age requirement without revealing their
              actual birthdate.
            </p>
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-green-800">
                <li>
                  ✅ <strong>Privacy-preserving</strong> - Only returns
                  true/false
                </li>
                <li>
                ...
                <li>
                  ✅ <strong>10-minute expiration</strong> - Time-limited
                  challenges
                </li>
                <li>
          ...
          <section id="security" className="mb-12">
            ...
            <ol className="space-y-3 text-gray-700 mb-6 list-decimal list-inside">
              <li>
                <strong>Your backend</strong> creates a challenge with your
                required age
              </li>
              <li>CardlessID generates a unique, single-use challenge ID</li>
              <li>User scans QR code with their wallet</li>
              <li>
                Wallet verifies age requirement and responds to CardlessID
              </li>
              <li>
                <strong>Your backend</strong> polls or receives webhook to
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-yellow-800">
                ...
                <li>
                  • User cannot modify the age requirement (it's stored
                  server-side)
                </li>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="space-y-1 text-blue-800">
                  ...
                  <li>
                    • Handle all status states: pending, approved, rejected,
                    expired
                  </li>
