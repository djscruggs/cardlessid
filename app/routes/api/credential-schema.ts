  ...
  return Response.json(
    {
      ...
      fields: {
        ...
        "cardlessid:compositeHash": {
          type: "string",
          description:
            "SHA-256 hash of firstName|middleName|lastName|birthDate",
